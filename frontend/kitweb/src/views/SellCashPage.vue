...
const PRODUCT_TYPES = ['กรรไกร','กระดาษ', 'กระพรวน', 'กาวแท่ง', 'ก้านลูกโป่ง', 'กล่อง', 'ก้ามปู', 'กากเพชร', 'กำมะหยี่', 'กิ๊ป', 'เกสร', 'กระดุม', 'กระดิ่ง', 'เข็มมุด', 'เข็มสอย', 'เข็มเนา', 'เข็มควัก', 'ด้ายหลอด', 'ด้านวีสปัน', 'ด้านแกน', "ยางแผง", "ยางม้วน", "ยางหลอด", "ริบบิ้น","ริบบิ้นซาติน", "ริบบิ้นไนล่อน", "ริบบิ้นผ้า", "ริบบิพับเหรียญ", "ริบบิ้นฟาง", "ลวด", "ลวดพันก้าน", "ล้วดต้น", "ล้วดวง", "ไหมนก", "ไหมวีนัส", "ไหมเส้นใหญ่", "ไหมซัมเมอร์", "ไหมเบบี้", "ไหมญีปุ่น", "ลูกปัด", "ใบไม้", "มีดคว้าน", "เชือกเทียน" ];
